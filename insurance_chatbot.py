...
st.markdown("Ask about Life, Health, Auto, or Home Insurance.")
        ...
        try:
            ...
            with st.expander("Sources"):
                for doc in result["source_documents"]:
                    st.write(doc.page_content[:300] + "...")  # Show preview of matched doc
        except Exception as e:
            st.error("Could not answer. Please try again later.")
            st.info("Contact support@insurancecorp.com")
            st.text(str(e))  # For debugging
